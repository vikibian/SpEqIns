...
import com.neu.test.util.encrypt.BASE64Decoder;
import com.neu.test.util.encrypt.BASE64Encoder;
...
public class EncryptUtil {
  ...
  public static String key = "cc839cf9feba4ed7ba68064177a0555b505hfbdfbfjsdfsbfmnsd";
  ...
  public static String encrypt(String xmlStr) {
    ...
    try {
      ...
      System.out.println(md5Hasn.length+"");
      // 组合消息体
      ...
      byte[] temp = EncryptUtil.AES_CBC_Encrypt(totalByte, deskey, ivParam);
      BASE64Encoder encoder = new BASE64Encoder();
      result = encoder.encode(temp);
  ...
  public static String decrypt(String xmlStr) {
    ...
    try {
      ...
      SecretKeySpec deskey = new SecretKeySpec(key, "AES");
      IvParameterSpec ivParam = new IvParameterSpec(iv);
      byte[] temp = EncryptUtil.AES_CBC_Decrypt(encBuf, deskey, ivParam);
      // 进行解密后的md5Hash校验
   ...
   * @throws Exception
   */
  public static byte[] AES_CBC_Encrypt(byte[] sourceBuf, SecretKeySpec deskey, IvParameterSpec ivParam)
    throws Exception {
    byte[] cipherByte;
    // 使用DES对称加密算法的CBC模式加密
   ...
   * @throws Exception
   */
  public static byte[] AES_CBC_Decrypt(byte[] sourceBuf, SecretKeySpec deskey, IvParameterSpec ivParam)
    throws Exception {
