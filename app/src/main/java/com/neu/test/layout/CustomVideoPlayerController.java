 ...
 */
public class CustomVideoPlayerController extends NiceVideoPlayerController
    ...
    private void init() {
        LayoutInflater.from(mContext).inflate(R.layout.custom_nice_video_controller, this, true);
